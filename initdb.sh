...
echo 'CREATE TABLE GAME(UUID TEXT PRIMARY KEY NOT NULL, NAME TEXT NOT NULL, CREATION_DATE TEXT NOT NULL, END_DATE TEXT NOT NULL, STATUS TEXT NOT NULL, CODE TEXT NOT NULL);' >> $db_file_name
#GAME.STATUS: PENDING, ACTIVE, ENDED

# table to store users
# the 'code' is a security system to verify an attempt to fulfill a contract
echo 'CREATE TABLE USER(UUID TEXT PRIMARY KEY NOT NULL, GAME_UUID TEXT NOT NULL, FIRST_NAME TEXT NOT NULL, LAST_NAME TEXT NOT NULL, EMAIL TEXT NOT NULL, CODE TEXT NOT NULL);' >> $db_file_name

# table to link players by contracts in the current game
# french contract example: "Bonjour {killer}, tu vas devoir tuer {victim} en le/la faisant {challenge}."
echo 'CREATE TABLE CONTRACT(UUID TEXT PRIMARY KEY NOT NULL, GAME_UUID TEXT NOT NULL, CREATION_DATE TEXT NOT NULL, KILLER_UUID TEXT NOT NULL, VICTIM_UUID TEXT NOT NULL, CHALLENGE_UUID TEXT NOT NULL, STATUS TEXT NOT NULL);' >> $db_file_name
#CONTRACT.STATUS: ACTIVE, SUCCESS, FAILURE, ENDED

# table to store attempts to fulfill a contract
echo 'CREATE TABLE ATTEMPT(UUID TEXT PRIMARY KEY NOT NULL, KILLER_UUID TEXT NOT NULL, VICTIM_UUID TEXT NOT NULL, CREATION_DATE TEXT NOT NULL, STATUS TEXT NOT NULL);' >> $db_file_name
