...
-- french contract example: "Bonjour {killer}, tu vas devoir tuer {victim} en le/la faisant {challenge}."
CREATE TABLE CONTRACT(UUID TEXT PRIMARY KEY NOT NULL, CREATION_DATE TEXT NOT NULL, GAME_UUID TEXT NOT NULL, KILLER_UUID TEXT NOT NULL, VICTIM_UUID TEXT NOT NULL, CHALLENGE_UUID TEXT NOT NULL, STATUS TEXT NOT NULL);
